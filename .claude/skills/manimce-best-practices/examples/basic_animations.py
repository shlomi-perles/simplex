...
Run with: python -m manim -pql basic_animations.py SceneName
"""
...
class ShapeCreation(Scene):
    ...
    def construct(self):
        ...
        # Arrange shapes
        shapes = VGroup(circle, square, triangle).arrange(RIGHT, buff=LARGE_BUFF)
...
class LaggedAnimations(Scene):
    ...
    def construct(self):
        ...
        dots = VGroup(*[
            ...
            for i in range(25)
        ]).arrange_in_grid(rows=5, cols=5, buff=MED_LARGE_BUFF)
...
class GroupOperations(Scene):
    ...
    def construct(self):
        ...
        # Arrange vertically
        self.play(shapes.animate.arrange(DOWN, buff=MED_LARGE_BUFF))
        self.wait()
