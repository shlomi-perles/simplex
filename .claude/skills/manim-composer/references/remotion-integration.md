...
# python -m manim + Remotion Integration Pipeline
...
# Render
python -m manim -qh --fps 30 --format mp4 scenes/s01_intro.py S01Intro
python -m manim -qh --fps 30 --format mp4 scenes/s02_method.py S02Method
python -m manim -qh --fps 30 --format webm -t scenes/s03_overlay.py S03Overlay
...
paper-explainer/
  ...
  remotion/                 # Remotion project
    public/
      clips/                # python -m manim output goes here
        clip_hook_01.mp4
        clip_problem_02.mp4
...
Render: python -m manim remotion-render
